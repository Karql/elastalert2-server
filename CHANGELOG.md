...
### Changes
* Update elastalert2 to v2.26.0 #104

## 5.16.0

### Changes
* Update elastalert2 to v2.25.0
* Update npm packages
* Update build image to alpine:3.22
* Update main image to node:24.10-alpine3.22
...
* Update npm packages
* Update build image to alpine:3.21
