...
:heavy_check_mark: Support the latest version of [ElastAlert2](https://github.com/jertel/elastalert2) - DONE! Check this release: [5.0.0-next.2](https://github.com/Karql/elastalert/releases/tag/5.0.0-next.2) for more details.
